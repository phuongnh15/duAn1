...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        listMenu1.addItem(new Model_Menu("1", "<html><span style='font-size:15px;'>Trang Chủ</span></html>", Model_Menu.MenuType.MENU));
        ...
        listMenu1.addItem(new Model_Menu("5", "<html><span style='font-size:15px;'>Bán Chạy</span></html>", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("", " ", Model_Menu.MenuType.EMPTY));

        listMenu1.addItem(new Model_Menu("6", "<html><span style='font-size:15px;'>Doanh Thu</span></html>", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("", " ", Model_Menu.MenuType.EMPTY));
        
        listMenu1.addItem(new Model_Menu("7", "<html><span style='font-size:15px;'>Thoát</span></html>", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("", " ", Model_Menu.MenuType.EMPTY));
